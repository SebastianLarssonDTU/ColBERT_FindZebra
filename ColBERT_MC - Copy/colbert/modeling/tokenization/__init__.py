...
from colbert.modeling.tokenization.utils_MC import tensorize_triples_MC_train
from colbert.modeling.tokenization.utils_MC import tensorize_triples_MC_test